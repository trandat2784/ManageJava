...
public class NhapHang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, -1, 340));
        ...
        getContentPane().add(cboLoaiSanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 130, 30));
        ...
        getContentPane().add(txtTim, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, 160, -1));
        ...
        getContentPane().add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 10, 40, 30));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(494, 10, 500, 220));

        txtSoLuong.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        txtSoLuong.setText("1");
        getContentPane().add(txtSoLuong, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 420, 60, -1));
        ...
        getContentPane().add(addProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 420, -1, -1));
        ...
        getContentPane().add(textTongTien, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 370, 137, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 420, -1, -1));
        ...
        getContentPane().add(deleteProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 420, -1, -1));
